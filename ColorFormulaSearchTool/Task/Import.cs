...
namespace ColorFormulaSearchTool.Task
{
    ...
    public class Import
    {
        ...
        /// 导入Excel
        /// </summary>
        /// <param name="typeid">0:导入配方单价运算记录 1:导入色母单价更新列表</param>
        /// <param name="fileAdd">地址</param>
        /// <returns></returns>
        public DataTable ImportExcelToDt(int typeid, string fileAdd)
        {
            ...
            try
            {
                ...
                var importExcelDt = OpenExcelToDataTable(typeid,fileAdd);
                //将从EXCEL过来的记录集为空的行清除
        ...
        /// </summary>
        /// <param name="typeid">0:导入配方单价运算记录 1:导入色母单价更新列表</param>
        /// <param name="fileAddress">导入地址</param>
        /// <returns></returns>
        private DataTable OpenExcelToDataTable(int typeid, string fileAddress)
        {
            ...
            var dt = new DataTable();
            //获取动态生成绑定字段临时表
            dt = typeid == 0 ? tempDt.ImportTempdt() : tempDt.ImportPriceList();
